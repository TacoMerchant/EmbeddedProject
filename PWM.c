...
// Change PWM_CC_PWMDIV_2 to prescale SYSCLK enought to achieve
// a 20millisecond PWM period using a 16 bit counter
//****************************************************************************
...
#define PWM_CC_PWMDIV_2         0x00000005  // /64 ///////////////// then divide by 0x927C
